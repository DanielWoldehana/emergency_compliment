...
class Compliment extends Component {
    ...
    render() {
        return (
            <div>
                {this.state.data[(Math.random()*this.state.data.length)+1]}
